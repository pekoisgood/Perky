...
const ProfileSidebar = () => {
  return (
    <>
      <div className="absolute left-[50%] translate-x-[-50%] bottom-[19px] bg-[#F9E2AF] rounded-[500px] w-[350px] h-[55px] sm:h-[70px] z-0" />
      <div className="flex items-center justify-center gap-5 absolute left-[50%] bottom-[8px] sm:bottom-[13px] translate-x-[-50%] z-10 w-[350px] h-[40px] sm:h-[60px]">
        <Link
