    ...
    <div className="flex sm:flex-row flex-col items-center justify-start sm:pl-5 gap-10 h-full w-full">
      ...
      <div className="flex flex-col sm:items-start items-center h-[75%] w-full">
        ...
        <Link
          ...
          className="absolute top-[4px] right-0 group w-[78px] h-[39px] bg-[#2B3467] rounded-md hover:cursor-pointer "
        >
          <div className="relative w-[90px] h-[39px] z-10">
            <div className="flex items-center gap-[1px] h-full relative before:absolute before:block before:top-0 before:left-[-2px] before:content-[ ] before:w-[80px] before:h-[39px] before:bg-[#333e7a] before:rounded-md px-[3px] py-1 z-20 before:border-2 before:border-black before:hover:skew-x-12 before:hover:h-[36px] before:hover:top-[3px] before:hover:left-[-7px] group-hover:duration-100">
              <span className="inline-block relative text-[12px] text-white group-hover:left-[-6px] group-hover:duration-100">
                New Club +
              </span>
            </div>
